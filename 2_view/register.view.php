<?php
	if (empty($_SESSION['user']) || $_SESSION['user'] == "")
	{
		...
		function script()
		{
			if ($_GET['error'] == 'script')
				echo '<p class="error"> Scripts are forbidden </p>';
		}

		function login_format()
		{
			if ($_GET['error'] == 'login_format')
